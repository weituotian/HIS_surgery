...
import com.his.surgery.dao.IBaseDao;
...
public class BaseDao<T, ID extends Serializable> implements IBaseDao<T, ID> {
     ...
     * 查询，返回某一页的list
     *
     * @param pageRequest 页面分页请求
     * @param hqlString   查询语句
     * @param values      语句变量
     * @return
     */
    public Page<T> findListByPageHQL(PageRequest pageRequest, String hqlString, Object... values) {
        Assert.notNull(pageRequest, "页面请求不能为空");
        Assert.notNull(hqlString, "hqlSting不能为null!");
        Assert.hasText(hqlString, "hqlString不能为空！");
