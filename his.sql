...
--
-- Host: 127.0.0.1
-- Generation Time: 2016-06-22 19:23:21
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
(8, 8, 2, '周董周董周董周董', '周董周董', '这是一个麻醉记录', '这是一个麻醉记录这是一个麻醉记录', 1),
(9, 18, 4, 'asdadfgwerg', '算是', '死了', '死死死死死死死死', 1);
...
(9, 1, 3, 2, '广东省中山市', '广东省中山市', '2016-06-22 21:25:47', 1, NULL, NULL),
...
(4, '呵呵呵呵', '哈哈哈', '嗷嗷嗷 ', '多对多'),
(18, 'asdasf', 'asdasf', 'xsdasd', 'qweqwr');
