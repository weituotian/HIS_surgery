...
<table id="surgery_arrange_table" class="table">
    ...
    <tr>
        ...
        <td><label for="sur_name"></label>
            <input type="text" id="sur_name" class="common" value="<s:property value="surgery.name"/> " readonly>
        </td>
        <th>疾病诊断：</th>
        <td><label for="sur_disease"></label>
            <input type="text" id="sur_disease" class="common" value="<s:property value="surgery.disease"/> " readonly>
        </td>
    </tr>
    <tr>
        <th>医生：</th>
        <td>
            <input type="text" id="sur_doctor" class="common" placeholder="输入医生编号" value="<s:property value="surgery.doctor.id"/> " readonly>
